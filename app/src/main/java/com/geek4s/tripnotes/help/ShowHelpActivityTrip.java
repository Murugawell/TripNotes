...
public class ShowHelpActivityTrip extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        h.put("content", "This is trip name.\n By long clicking this you can edit or delete the trip");
        h.put("dismisstext", "Got It");
        l.add(h);
        ...
        h = new HashMap<>();
        h.put("view", f_date);
        h.put("content", "This is trip created date.");
        h.put("dismisstext", "Got It");
        l.add(h);
