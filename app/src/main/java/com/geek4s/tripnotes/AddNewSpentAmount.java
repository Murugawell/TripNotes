...
//        window.setAttributes(wlp);
        ...
        final EditText editText_amount = (EditText) promptsView.findViewById(R.id.add_amount_value);
        final EditText editText_amount_for = (EditText) promptsView.findViewById(R.id.add_amount_for);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String personname, amountspent, amount, to;
                personname = editText_person_name.getText().toString();
                amountspent = editText_amount.getText().toString();
                amount = editText_amount_for.getText().toString().trim();
